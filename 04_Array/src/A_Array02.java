...
//		// Heap 이라는 공간에 절대 빈공간이 존재할 수 없어서
...
//		// 705927765
//		
//		System.out.println("안녕하세요".length()); //String "안녕하세요" 의 길이
//		// 5 ( "안" = 1 \"녕" = 2 \"하" = 3 \"세" = 4 \"요" = 5 총 = 5 )
//		
//		System.out.println(iArr.length); // 배열의 길이
//		// 10   ( int[] iArr = new int[10]; )
...
//		System.out.println(arr.hashCode()); // 705927765
//		arr = new int[7];
