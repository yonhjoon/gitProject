...
public class B_switch01 {
	 ...
	 * 
	 * 	다만, if 문과의 "차이점"이라면
	 * 	> if 문은 조건식을 자유롭게 기술할 수 있다.
	 * 	  switch 문은 동등비교로 밖에 수행되지 않는다.
...
//		}
//		// 정수(1~3) : 1		정수(1~3) : 2			정수(1~3) : 3
//		// 빨간색입니다.		파란색입니다.			초록색입니다.
//		
//		
//		
//		//if 를 사용하는 경우
...
//		}
//		
//		// 구매하고자하는 과일(사과(1000), 바나나(2000), 딸기(3000)) 입력 : 딸기 / 바나나 / 사과
//		// 딸기의 가격은 3000원입니다.  / 2000  / 1000
//		
//		
//		if (fruit.equals("사과")) {
//			System.out.println("사과의 가격은 1000원입니다.");
...
//		// 딸기의 가격은 3000원입니다. // 2000  //  1000
	...
	// 월을 입력하세요 : 1		월을 입력하세요 : 4		월을 입력하세요 : 2		월을 입력하세요 : 13
	// 1월은 31일까지입니다		4월은 30일까지입니다		2월은 28일까지입니다		1~12까지만 입력가능합니다.
}
