...
//		}
//		
//		System.out.println(age + "세는 " + type + "에 속합니다."); // 첫번째 두번쨰 방법 다 동일함
//		
//		// 나이(정수만) : 10			나이(정수만) : 16			나이(정수만) : 20
//		// 10세는 어린이에 속합니다.		16세는 청소년에 속합니다.		20세는 성인에 속합니다.
...
//		
//		// 성별(m/f) : m / M			성별(m/f) : f / F
//		// 장용준님은 남학생입니다.		장용준님은 여학생입니다.
		...
		// 정수(양수) 입력 : 10			정수(양수) 입력 : 1			정수(양수) 입력 : -1
		// 짝수다.					홀수다.					양수가 아닙니다. 잘못입력하셨습니다.
