...
//		// 문자 하나 입력 : A
//		// 사용자가 입력한 값이 대문자입니다 : true
//		// 문자 하나 입력 : a
//		// 사용자가 입력한 값이 대문자입니다 : false
...
//		
//		boolean bl = gender =='f' || gender == 'F';
//		System.out.println("사용자가 여자입니까? : "+ bl);
//		System.out.println("사용자는 " + (bl ? "남자" : "여자") + "입니다.");
//		// 성별(M/F) :  M
//		// 사용자가 여자입니까? : false
//		// 사용자는 여자입니다.
